...
//CHANGED BELOW BY LIAM (added conduction collision models)
enum CollisionModel {none, electron, ion, test, boltzmann, conduct_elec, conduct_ion};  //test = boltzmann test particles
